        ...
        <div class="">
            <div class="text-center">
                <div class="">
                    ...
                    {!! Form::open(['id'=>'msform', 'action' => 'FacultyController@store', 'method'=>'POST']) !!} 
                        <!-- progressbar -->
                        <!-- <div>
                        ...
                        <fieldset>
                            <div class="form-card">
                                <label class="fieldlabels">For class</label> 
                                <input type="text" name="class" placeholder="For class" /> 
                                <label class="fieldlabels">Expected Crowd</label> 
                                <input type="number" name="crowd" placeholder="Expected Crowd" /> 
                                <label class="fieldlabels">Expected Guests/Speaker/company name</label> 
                                <input type="text" name="guests" placeholder="Guests/Speaker/Company name" /> 
                                <label class="fieldlabels">Speaker/Guests with Designation and Company</label> 
                                <input type="text" name="designation" placeholder="Designation/Company name" />
                            </div> <button type="submit" form="msform" class="action-button" value="Submit">Submit</button>
                        </fieldset>
                        <!-- <fieldset>
                            <div class="form-card">
                                <div class="row">
