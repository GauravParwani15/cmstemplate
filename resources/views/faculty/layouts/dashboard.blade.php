            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        @if( (session('e_id') && session('type')==1) || (session('e_id') && session('type')==50 && session('cmsrole')==33 ) )
                            <li>
                            ...
                            <ul class=" nav nav-second-level" class="collapse" id="services">
                                ...
                                <a href="{{ url ('/staff/booking') }}" ><i class="fa  fa-users fa-fw "></i>  Resource Booking</a>
                                </li>
                            </ul>
                            </li>
                        @elseif( [session('e_id') && session('type')==50 && session('cmsrole')==32 ]  )
                            <li>
