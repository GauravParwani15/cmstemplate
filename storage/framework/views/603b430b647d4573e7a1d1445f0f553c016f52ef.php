<?php $__env->startSection('page_heading','New Booking'); ?>
 ...
 <ul class="list-group list-group-horizontal">
        ...
        <div class="">
            <div class="text-center">
                <div class="">
                    ...
                    <?php echo Form::open(['id'=>'msform', 'action' => 'BookingsController@store', 'method'=>'POST']); ?> 
                        <!-- progressbar -->
                        ...
                        <fieldset>
                            <div class="form-card">
                                ...
                                <a href="<?php echo e(url ('/staff/new_booking')); ?>"><button type="button" class="btn btn-info">New Booking request</button></a>
                            </div>
                        </fieldset>
                    <?php echo Form::close(); ?>
  ...
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.4/jquery.min.js"></script>
   <script type="text/javascript" src="<?php echo e(asset('js/script.js')); ?>"></script>
    <!-- <script src="<?php echo e(URL::asset('js/style.js')); ?>"></script> -->
  <!-- <script src="<?php echo e(URL::asset('js/style.js')); ?>" > -->
