	...
	<div class="jumbotron ">
		<div class="container-fluid bg-3 ">
			...
			<div class="col-sm-10">
				...
				<div class="form-group">
						<?php echo e(Form::text('stuname',$students->first_name.' '.$students->last_name,['class' => 'form-control','placeholder'=>'Student Name','disabled'])); ?>

				</div>
				<div class="form-group">
						<?php echo e(Form::number('phoneno',$students->mobile_no,['class' => 'form-control','placeholder'=>'Mobile Number','disabled'])); ?>

				</div>
				<div class="form-group">
						<?php echo e(Form::date('dob',$students->date_of_birth,['class' => 'form-control','placeholder'=>'Date of Birth','disabled'])); ?>
				...
				<div class="form-group">
						<?php echo e(Form::text('academicyearAdmission',$students->admission_year,['class' => 'form-control','placeholder'=>'Academic Year Of Admission','disabled'])); ?>
