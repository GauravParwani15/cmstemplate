...
@media  screen and (max-width: 500px) {
  ...
  width: 30%;}
    ...
    <ul class="list-group list-group-horizontal">
        <li >
            <a href="<?php echo e(url ('/staff/new_booking')); ?>"><button class="btn btn-primary">Book a new Resource</button></a>
             <a href="<?php echo e(url ('/staff/check_availability')); ?>"><button class="btn btn-primary float-right">Check Availability</button></a>
        </li>
        ...
        <div class="pt-5" style="background-color:white;">
            <div class="card" style="border: none;">
                ...
                <div class="card-body">
                    <table class="">
                        <tr>
                            <div class="container">
                            <?php echo Form::open(['id'=>'searchform', 'action' => 'FacultyController@search', 'method'=>'POST']); ?>
                            ...
                            <th></th>
                                <th>
                                    <?php echo Form::open(['style'=>'display:flex; flex-direction:row;','class'=>'form-inline','id'=>'filterform', 'action' => 'FacultyController@filter', 'method'=>'POST']); ?>
            ...
            <table class="table bg-light">
                ...
                <tbody>
                    ...
                    <tr  class="text-left">
                        <td><a href= "<?php echo e(route('booking_data',['id'=>$booking->booking_id])); ?>"><?php echo e($booking->event_name); ?></a></td>
            ...
            <div class="container">
                <div class="pt-5" style="background-color:white;">
                    ...
                    <table class="table text-light">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $bookings_hist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking_hist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr  class="text-left">
                                    <td><a href= "<?php echo e(route('history_data',['id'=>$booking_hist->booking_id])); ?>"><?php echo e($booking_hist->event_name); ?></a></td>
                                    <td><?php echo e($booking_hist->resource->name); ?></td>
                                    <td><?php echo e($booking_hist->event_date); ?></td>
                                    <td><?php echo e($booking_hist->start_time); ?></td>
                                    <td><?php echo e($booking_hist->end_time); ?></td>
                                    <?php if($booking_hist->status == 0): ?>
                                        <td class = "bg-warning">Pending</td>
                                    <?php elseif($booking_hist->status == 1): ?>
                                        <td class = "bg-success">Accepted</td>
                                    <?php elseif($booking_hist->status == 2): ?>
                                        <td class = "bg-danger">Rejected</td>
                                    <?php else: ?>
                                        <td class = "bg-danger">Cancelled</td>
                                    <?php endif; ?> 
