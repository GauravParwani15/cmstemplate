...
<script type="text/javascript">
    window.onload = function() {
        ...
        document.querySelector('#btnCrop').addEventListener('click', function(){
            ...
            // var base64result = reader.b64Data.split(',')[1];
            ...
            // var cropcanvas = $('#file').cropper('getCroppedCanvas');
            // var croppng = cropcanvas.toDataURL("image/png");    
            document.querySelector('.cropped').innerHTML = '<div class="col-md-3"><form action="/staff/image" method="post"><input name="url" type="hidden" value="'+b64Data+'"><input type="hidden" name="_token" id="csrf-token" value="<?php echo e(Session::token()); ?>" /><img src="'+b64Data+'" class="img-rounded"><br><br><input class="btn btn-success  "type="submit" value="Select as Profile Picture"></form></div>';
        })
